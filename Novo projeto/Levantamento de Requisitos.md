...
## Como é feito o cadastro desse cliente? Quando o pedido é registrado os dados são coletados para registro do cliente ou terá um dashboard dedicado para ele se cadastrar?
...
## A aplicação deve apenas ser capaz de receber pedidos e aplicar logica antifraude?
...
## O que seria esse pagamento? Como ele é feito?
...
## O que seria essa analise manual?
...
## A aplicação será acessada apenas para fins de monitoramento de pessoal responsável, não sendo disponivel para clientes?
...
## Quais são os estados possíveis que um pedido pode apresentar?
...
## Como funciona as regras da logica antifraude? 
...
## A restrição vai ser aplicada como a média de tudo o que foi analisado ou por condições satisfeitas em cada topico?
...
## Quem é responsável por aprovar ou rejeitar? Como funciona isso? Não é o sistema que automaticamente trava?
...
## Qual o tempo para reversão manual?
